...
export const LaptopFrame = ({ children }: { children: React.ReactNode }) => (
    <div className="relative mx-auto max-w-4xl w-full">
        <div className="relative bg-gray-900 rounded-2xl sm:rounded-3xl p-2 sm:p-3 shadow-2xl">
            <div className="bg-black rounded-xl sm:rounded-2xl p-1 sm:p-2">
                <div className="bg-white rounded-lg overflow-hidden shadow-inner">
                    {children}
                </div>
            </div>
            <div className="h-4 sm:h-6 bg-gray-800 rounded-b-xl sm:rounded-b-2xl shadow-lg relative">
